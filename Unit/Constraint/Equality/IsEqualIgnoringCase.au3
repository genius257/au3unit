...
; https://github.com/sebastianbergmann/phpunit/blob/12.1.2/src/Framework/Constraint/Equality/IsEqualIgnoringCase.php
; https://github.com/sebastianbergmann/phpunit/blob/6f2775cc4b7b19ba5a411c188e855eb0cc78a711/src/Framework/Constraint/Equality/IsEqualIgnoringCase.php
...
Func Au3UnitConstraintIsEqualIgnoringCase_Matches($other, $exspected, $description)
    ; If $expected and $other are identical, they are also equal.
    ; This is the most common path and will allow us to skip
    ; initialization of all the comparators.
    If Au3UnitConstraintIsEqualIgnoringCase_StrictEquals($other, $exspected) Then
        Return True
    EndIf
    ...
    Local $e = Call($comparator&"_assertEquals", $exspected, $other, 0.0, False, True)
	Local $error = @error
...
Func Au3UnitConstraintIsEqualIgnoringCase_StrictEquals($a, $b)
    If Not (VarGetType($b) == VarGetType($b)) Then Return False
    Return (IsString($a) And $a == $b) Or $a = $b
EndFunc

Func Au3UnitConstraintIsEqualIgnoringCase_ToString($value)
